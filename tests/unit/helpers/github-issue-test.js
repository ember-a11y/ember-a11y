...
test('Github Issue helper generates correct link url', function(assert) {
  ...
  let linkStr = githubIssue([testStr]);
  assert.equal(linkStr, 
  	'https://github.com/nathanhammond/ember-a11y/issues/new?title=Demo%20App%20Test%20fail%3A%20Highly%20Topical');
});
